...
class PlotController extends Controller
{
   ...
   public function store(Request $request, Farm $farm)
    ...
    $crops = Crop::all(); // Fetch all available crops
    return view('farmdetails.plots.edit', compact('farm', 'plot', 'crops'));
    }
    ...
    'min_longitude'  => 'required|numeric',
    'max_longitude'  => 'required|numeric|gte:min_longitude',
    'cropID'         => 'nullable|exists:crops,id', // 👈 add this
    ]);
    ...
    'min_longitude' => $request->input('min_longitude'),
    'max_longitude' => $request->input('max_longitude'),
    'cropID'        => $request->input('cropID'), // 👈 and this
    ]);
